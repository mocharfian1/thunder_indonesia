...
<ul class="sidebar-menu tree" data-widget="tree">
  ...
  <?php } ?>
  <?php if($user == 'Super Admin'||$user=='Kepala Divisi' || $user == 'Admin'||$user=='Admin Gudang'){ ?>
    <li class="treeview <?php echo $s_active=='consumable' || $s_active=='consumable-transaksi' || $s_active=='consumable-SPAREPART' || $s_active=='consumable-ATK' || $s_active=='consumable-PENDUKUNG' || $s_active=='consumable-kategori_sub' ? 'active':''; ?>">
      <a href="#">
...
<?php if($user == 'Super Admin'){ ?>
  <li class="treeview <?php echo $s_active=='report_driver' ? 'active':''; ?>">
    ...
    <ul class="treeview-menu">
      <li class="<?php echo $s_active=='report_driver' ? 'active':''; ?>">
        <a href="<?php echo base_url('report/report_driver'); ?>">
          <i class="fa fa-file"></i> <span>Laporan Driver</span>
        </a>
      </li>
      <li class="<?php echo $s_active=='report_jurnal' ? 'active':''; ?>">
        <a href="<?php echo base_url('report/report_jurnal'); ?>">
          <i class="fa fa-file"></i> <span>Laporan Jurnal</span>
        </a>
      </li>
    </ul>
  </li>
