...
<head>
  ...
  <title>Register | Thunder Indonesia</title>
...
<!--     <?php
  ...
  <div class="login-box-body">
    <p class="login-box-msg">Lengkapi Form Dibawah Untuk Registrasi</p>
    ...
    <form id="frm_reg">
      ...
      <div class="form-group has-feedback">
        <input type="text" class="form-control" name="group" placeholder="Masukkan Group">
        <span class="glyphicon glyphicon-user form-control-feedback"></span>
      </div>
      <div class="form-group has-feedback">
